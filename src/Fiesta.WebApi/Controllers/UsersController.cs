...
namespace Fiesta.WebApi.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        public async Task<ActionResult<SkippedItemsResponse<GetFriendRequests.ResponseDto>>> GetFriendRequests(string id, GetFriendRequests.Query query, CancellationToken cancellationToken)
        {
            query.Id = id;
            var response = await Mediator.Send(query, cancellationToken);
            return Ok(response);
